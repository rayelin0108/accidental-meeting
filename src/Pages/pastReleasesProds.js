...
const PastReleasesProds = () => {
  ...
  const [mainImage, setMainImage] = useState(head4);
  const [currentIndex, setCurrentIndex] = useState(0);

  const images = [head4, head3, head2, head1];
  ...
  return (
    <>
      <section className="pastReleasesPage">
        {/* 購物導覽 */}
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="_product-detail-content">
              <div className="product-title">
                <p className="_p-name"> 鳶尾魚魚iris </p>
                <div className="p-list">
                  <span className="price"> NT$ 8,900 </span>
                </div>
                ...
                <div className="_p-add-cart">
                  <form className="ProductMenu">
                    ...
                    <div className="quantity-box">
                      ...
                      <div className="quantity-container">已售完
                      </div>
                    </div>
                  </form>
                </div>
        ...
        <div className="withmackupImg">
          <div className="imgBig">
            <div className="img1">
              <img src={head3} alt="官方妝面圖照片1" />
            </div>
            <div className="img2">
              <img src={head4} alt="官方妝面圖照片2" />
            </div>
          </div>
        </div>
...
export default PastReleasesProds;
