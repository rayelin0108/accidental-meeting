...
import dollsImg_iris from "../assets/dolls/theDoll/iris.png";
import dollsImg_bobo from "../assets/dolls/theDoll/bobo.png";
import dollsImg_pipi from "../assets/dolls/theDoll/pipi.png";
import dollsImg_roce from "../assets/dolls/theDoll/roce.png";
import dollsImg_lion from "../assets/dolls/theDoll/lion.png";
import dollsImg_yoyo from "../assets/dolls/theDoll/yoyo.png";
import dollsImg_bibi from "../assets/dolls/theDoll/bibi.png";
import dollsImg_meow from "../assets/dolls/theDoll/meow.png";
            ...
            <div className="phone-SML">
              <div className="dollTopBox">
                <div className="thePhoneBox1">
                  <Link to="/product-Page">
                    <img src={dollsImg_pipi} alt="甜心派派pipig手機板圖片" />
                    <h1>甜心派派pipi</h1>
                  </Link>
                </div>
                <div className="thePhoneBox2">
                  <Link to="/product-Page">
                    <img src={dollsImg_coco} alt="酒心可可手機板圖片" />
                    <h1>酒心可可coco</h1>
                  </Link>
                </div>
              </div>
              <div className="dollBottomBox">
                <div className="thePhoneBox3">
                  <Link to="/product-Page">
                    <img src={dollsImg_roce} alt="玫瑰茶茶手機板圖片" />
                    <h1>玫瑰茶茶roce</h1>
                  </Link>
                </div>
          ...
          <div className="futureSale-phone">
            <div className="phone-SML">
              <div className="dollTopBox">
                <div className="thePhoneBox1">
                  <Link to="/product-Page">
                    <img src={dollsImg_bobo} alt="水手啵啵BOBO手機板圖片" />
                    <h1>水手啵啵BOBO</h1>
                  </Link>
                </div>
                <div className="thePhoneBox2">
                  <Link to="/product-Page">
                    <img src={dollsImg_yoyo} alt="惡魔幼幼yoyo手機板圖片" />
                    <h1>惡魔幼幼yoyo</h1>
                  </Link>
                </div>
              </div>
              <div className="dollBottomBox">
                <div className="thePhoneBox3">
                  <Link to="/product-Page">
                    <img src={dollsImg_bibi} alt="天使白白bibi手機板圖片" />
                    <h1>天使白白bibi</h1>
                  </Link>
                </div>
                <div className="thePhoneBox4">
          ...
          <div className="pastSale-phone">
            <div className="phone-SML">
              <div className="dollTopBox">
                <div className="thePhoneBox1">
                  <Link to="/pastReleases-Prods">
                    <img src={dollsImg_meow} alt="調皮喵喵meow手機板圖片" />
                    <h1>調皮喵喵meow</h1>
                  </Link>
                </div>
                <div className="thePhoneBox2">
                  <Link to="/pastReleases-Prods">
                    <img src={dollsImg_iris} alt="鳶尾魚魚iris手機板圖片" />
                    <h1>鳶尾魚魚iris</h1>
                  </Link>
                </div>
              </div>
              <div className="dollBottomBox">
                <div className="thePhoneBox3">
                  <Link to="/pastReleases-Prods">
                    <img src={dollsImg_lion} alt="獅子崽崽lion手機板圖片" />
                    <h1>獅子崽崽lion</h1>
                  </Link>
                </div>
                <div className="thePhoneBox4">
